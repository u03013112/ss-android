 ...
 *    &lt;application&gt;
 *        ...
 *        &lt;provider android:name="com.github.ss.$PLUGIN_ID.BinaryProvider"
 *                     android:authorities="com.github.ss.plugin.$PLUGIN_ID.BinaryProvider"&gt;
 *            &lt;intent-filter&gt;
 *                &lt;category android:name="com.github.ss.plugin.ACTION_NATIVE_PLUGIN" /&gt;
 *            &lt;/intent-filter&gt;
 *        &lt;/provider&gt;
 *        ...
 *    &lt;/application&gt;
